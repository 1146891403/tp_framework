namespace TP.WL.ERP.Data.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        MerchandiserName = c.String(),
                        SourceNumber = c.String(maxLength: 32),
                        SourceName = c.String(),
                        HowKnow = c.String(maxLength: 50),
                ...
                c => new
                    {
                        Id = c.Long(nullable: false),
                        ClientId = c.Long(nullable: false),
                        ClientNumber = c.String(nullable: false, maxLength: 32),
                        Number = c.String(nullable: false, maxLength: 32),
                        DisplayName = c.String(nullable: false, maxLength: 256),
                        Registration = c.String(maxLength: 256),
                        RegistrationDate = c.DateTime(nullable: false),
                        UnRegistrationRemark = c.String(maxLength: 1024),
                        Authorization = c.String(maxLength: 256),
                        AuthorizationDate = c.DateTime(nullable: false),
                        UnAuthorizationRemark = c.String(maxLength: 1024),
            ...
            CreateTable(
                "dbo.tpwl_crm_ClientCertificates",
                c => new
                    {
                        Id = c.Long(nullable: false),
                        ClientId = c.Long(nullable: false),
                        GrouptId = c.Long(nullable: false),
                        Number = c.String(nullable: false, maxLength: 32),
                        DisplayName = c.String(nullable: false, maxLength: 256),
                ...
                c => new
                    {
                        ...
                        AddressLine4 = c.String(maxLength: 256),
                        AddressLine5 = c.String(maxLength: 256),
                ...
                c => new
                    {
                        ...
                        EmployeeCount = c.String(nullable: false),
                        Website = c.String(),
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.tpwl_admin_Users", t => t.CreatorId)
                .ForeignKey("dbo.tpwl_admin_Users", t => t.ModificatorId)
                .ForeignKey("dbo.tpwl_crm_ClientFileTypes", t => t.Type_Id)
                .Index(t => t.ClientId)
                .Index(t => t.CreatorId)
                .Index(t => t.ModificatorId)
                .Index(t => t.Type_Id);
            ...
            CreateTable(
                "dbo.ClientCertificateClientCertificateGroups",
                c => new
                    {
                        ClientCertificate_Id = c.Long(nullable: false),
                        ClientCertificateGroup_Id = c.Long(nullable: false),
                    })
                .PrimaryKey(t => new { t.ClientCertificate_Id, t.ClientCertificateGroup_Id })
                .ForeignKey("dbo.tpwl_crm_ClientCertificates", t => t.ClientCertificate_Id, cascadeDelete: true)
                .ForeignKey("dbo.tpwl_crm_ClientCertificateGroups", t => t.ClientCertificateGroup_Id, cascadeDelete: true)
                .Index(t => t.ClientCertificate_Id)
                .Index(t => t.ClientCertificateGroup_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.tpwl_crm_ClientSignFiles", "Type_Id", "dbo.tpwl_crm_ClientFileTypes");
            ...
            DropForeignKey("dbo.tpwl_crm_ClientCertificates", "ModificatorId", "dbo.tpwl_admin_Users");
            DropForeignKey("dbo.ClientCertificateClientCertificateGroups", "ClientCertificateGroup_Id", "dbo.tpwl_crm_ClientCertificateGroups");
            DropForeignKey("dbo.ClientCertificateClientCertificateGroups", "ClientCertificate_Id", "dbo.tpwl_crm_ClientCertificates");
            DropForeignKey("dbo.tpwl_crm_ClientCertificates", "CreatorId", "dbo.tpwl_admin_Users");
            DropForeignKey("dbo.tpwl_crm_ClientCertificates", "ClientId", "dbo.tpwl_crm_Clients");
            ...
            DropIndex("dbo.ClientCertificateClientCertificateGroups", new[] { "ClientCertificateGroup_Id" });
            DropIndex("dbo.ClientCertificateClientCertificateGroups", new[] { "ClientCertificate_Id" });
            ...
            DropIndex("dbo.tpwl_crm_ClientSignFiles", new[] { "Type_Id" });
            ...
            DropIndex("dbo.tpwl_crm_ClientCertificates", new[] { "ModificatorId" });
            DropIndex("dbo.tpwl_crm_ClientCertificates", new[] { "CreatorId" });
            DropIndex("dbo.tpwl_crm_ClientCertificates", new[] { "ClientId" });
            ...
            DropTable("dbo.ClientCertificateClientCertificateGroups");
            ...
            DropTable("dbo.tpwl_crm_ClientFileTypes");
            ...
            DropTable("dbo.tpwl_crm_ClientCertificates");
