...
namespace TP.Data.Repository.EntityFramework
{
        ...
        where TEntity : EntityBase<TPrimaryKey>
    {
        ...
        public virtual Task<TEntity> FirstOrDefaultAsync(Expression<Func<TEntity, bool>> predicate, params Expression<Func<TEntity, object>>[] propertySelectors)
        {
        ...
        public abstract int BulkInsert(IEnumerable<TEntity> entities);

        public virtual Task<int> BulkInsertAsync(IEnumerable<TEntity> entities)
        {
            return Task.FromResult(BulkInsert(entities));
        }
